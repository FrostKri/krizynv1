...
await conn.sendButton(m.chat, `“${pickRandom(global.bucin)}”`, footer, 'Bucin', `${usedPrefix + command}`)
}
handler.help = ['bucin']
handler.tags = ['quotes']
...
global.bucin = [
  ...
  "Jika kamu ingin pergi bersamanya, pergilah\nTapi jika kamu tersesat ingatlah bahwa aku jalan pulang yang kau lupakan.",
  "Tiap kali aku liat kamu, aku berbunga-bunga. Apa ini yang namanya riba?",
  "Aky paling suka ngemil karena ngemil itu enak. Apalagi ngemilikin kamu sepenuhnya.",
  "Terkadang dengan melepaskannya adalah salah satu cara lain untuk mencintainya.",
  ...
  "Jadilah teman ceritaku, teman marahku, teman bercandaku, teman mainku, teman berjuangku, dan jadilah satu-satunya teman hidupku.",
  "Aku tidak bisa berjanji untuk menjadi yang baik. Tapi aku berjanji akan selalu mendampingi kamu.",
  ...
  "Ujang dari pekerjaan adalah kebosanan\nUjung dari cinta hanyalah tangisan.",
  "Jangan takut aku takkan hilang, jangan hilang aku bisa takut.",
  "Bagi aku, semua hari itu adalah hari Selasa. Selasa di Surga bila dekat denganmu.",
  "Mungkin aku bukan yang terbaik, namun setidaknya aku sudah mencoba.",
  "Tenang wae neng, ari cinta Akang mah sapertos tembang krispatih, Tak lekang oleh waktu.",
  "Kalau jelangkungnya kaya kamu, datang aku jemput, pulang aku anter deh..",
